...
const DISHES_DATA = [
  ...
  // ==========================================
  {
    ...
    category: "Dinner",
    mealTimes: ["lunch", "dinner"],
    tasteProfile: ["Creamy", "Savory", "Umami", "Peppery"],
    spiceLevel: 1,
    diet: ["non-veg", "high-protein"],
    moodTags: ["comfort", "date-night", "cheesy"],
    priceTier: "₹₹",
    price: 460,
    rating: 4.9,
    reviewsCount: 52000,
    calories: 640,
    prepTime: "20 mins",
    famousFor: "Silky pasta emulsion crafted strictly with egg yolks, Pecorino Romano, crispy guanciale, and freshly cracked black pepper (NO cream!).",
    description: "Pure Roman perfection. Al dente spaghetti tossed with rendered cured pork jowl (guanciale), emulsified with farm egg yolks, starchy pasta water, and sharp Pecorino Romano cheese for an intensely luscious velvety texture.",
    ingredients: ["Bronze-Die Spaghetti / Rigatoni", "Crispy Cured Guanciale (Pork Jowl)", "Fresh Egg Yolks", "Aged Pecorino Romano DOP", "Freshly Toasted & Cracked Black Peppercorns"],
    iconicSpots: ["Roscioli Salumeria (Rome)", "Da Enzo al 29 (Trastevere)", "Trattoria Da Cesare al Casaletto", "Flavio al Velavevodetto"],
    image: "https://images.unsplash.com/photo-1612874742237-6526221588e3?w=900&auto=format&fit=crop&q=80",
    recipeOverview: "Render guanciale till crispy. Whisk egg yolks with grated Pecorino and black pepper into thick paste. Toss hot al dente pasta off-heat with guanciale fat, egg mix, and pasta water to emulsify."
  },
  {
    id: "rome_gelato",
    name: "Artisanal Roman Gelato (Pistacchio & Stracciatella)",
    nativeName: "Gelato Artigianale",
    cityId: "rome",
    cityName: "Rome",
    country: "Italy",
    isGlobalIcon: true,
    ...
    trendingScore: 96,
    category: "Dessert",
    mealTimes: ["snack", "dinner", "late-night"],
    tasteProfile: ["Sweet", "Creamy", "Nutty", "Cold"],
    spiceLevel: 0,
    diet: ["veg", "vegetarian", "gluten-free"],
    moodTags: ["sweet", "date-night", "quick"],
    priceTier: "₹",
    price: 190,
    rating: 4.9,
    reviewsCount: 56000,
    calories: 260,
    prepTime: "Ready to serve",
    famousFor: "Slow-churned dense Italian ice cream made with Bronte pistachios and fresh whole milk.",
    description: "Denser, creamier, and richer in flavor than standard ice cream due to lower fat content and slower churning with minimal air incorporation. Served in crisp waffle cones with dollops of pure whipped cream (panna).",
    ingredients: ["Fresh Whole Milk & Cream", "Sicilian Bronte Pistachio Paste", "Dark Chocolate Shards", "Organic Cane Sugar"],
    iconicSpots: ["Frigidarium (Navona)", "Giolitti (Pantheon)", "Gelateria del Teatro (Coronari)", "Otaleg (Trastevere)"],
    image: "https://images.unsplash.com/photo-1560008581-09826d1de69e?w=900&auto=format&fit=crop&q=80",
    recipeOverview: "Churn fresh milk, pure pistachio paste, and natural stabilizers at slow speed to prevent aeration, serving at slightly warmer temperature than ice cream for maximum flavor release."
  },
